...
def handle_files(args):
    ...
    if args.delete:
        confirm = input("Are you sure you want to delete these files? This action is irreversible. To move instead, select 'n' (y/n): ").strip().lower()
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Delete or move specific files.")
    ...
    parser.add_argument('--delete', action='store_true', help="Delete the excess files")
